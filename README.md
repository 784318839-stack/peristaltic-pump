...
高速运转时电机出现抖动或丢步，待排查。可能原因：

| 疑因 | 说明 |
|------|------|
| 加速曲线过陡 | `setAcceleration()` 参数可能需进一步调优 |
| 74HCT125 未装 | ESP32 3.3V GPIO 直接驱动 DM542 光耦，电流处于临界值（~7.8mA），高速下光耦 CTR 下降 |
| 脉冲频率过高 | 400 pulse/rev 细分下，高转速对应高频脉冲 |
| 电源供电不足 | 24V 电源瞬态响应可能不够 |
